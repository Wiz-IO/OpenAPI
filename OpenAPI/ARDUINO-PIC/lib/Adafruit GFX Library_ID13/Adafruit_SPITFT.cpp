...
#else
        hwspi._spi->transfer((uint16_t)(w >> 8));
...
#else
        hwspi._spi->transfer((uint8_t)(l >> 24));
        hwspi._spi->transfer((uint8_t)(l >> 16));
        hwspi._spi->transfer((uint8_t)(l >> 8));
        hwspi._spi->transfer((uint8_t)(l));
#endif
    } else if(connection == TFT_SOFT_SPI) {
